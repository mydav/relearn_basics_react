...
export const Users = ({ items, isLoading, searchValue, onChangeSearchValue, invites, onClickInvite, onClickSend }) => {
  ...
  return (
    <>
      ...
      {invites.length > 0 && <button onClick={onClickSend} className="send-invite-btn">Send</button>}
    </>
  );
};
